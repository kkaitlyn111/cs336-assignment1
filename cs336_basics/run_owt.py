...
def run_owt(
    num_runs=1,
    project_name="transformer-lm-owt-final-leaderboard"):
    ...
    for batch in tqdm(batch_sizes, desc="Running batch sweep"):
        ...
        args.eval_freq = args.max_steps // 200  # evaluate more frequently
        args.log_freq = args.max_steps // 200
...
if __name__ == "__main__":
    results = run_owt(
        ...
        num_runs=1,   
        project_name="transformer-lm-owt-run" 
